...
Uint8ClampedArray_TypedArray = [ #	1	8-bit unsigned integer	unsigned char
	new Uint8ClampedArray([ 0xFF,  0x00, 0x00])#red
	new Uint8ClampedArray([ 0x00,  0xFF, 0x00])#green
]

Uint8ClampedArray_Buffer = (makeBufferFromTypedArray(n) for n in Uint8ClampedArray_TypedArray)

exports.DrawGLScene_Uint8ClampedArray_TypedArray = (winObj)-> #Here's Where We Do All The Drawing
	if debugDrawGLScene
	...
	gl.glColor3ubv(Uint8ClampedArray_Buffer[0])
	...
	gl.glColor3ubv(Uint8ClampedArray_Buffer[1])
...
exports.DrawGLScene_Uint8ClampedArray_Buffer = (winObj)-> #Here's Where We Do All The Drawing
	if debugDrawGLScene
		console.log 'DrawGLScene'
