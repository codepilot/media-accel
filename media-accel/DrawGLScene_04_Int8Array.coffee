...
Int8Array_TypedArray = [ #1	8-bit twos complement signed integer	signed char
	new Int8Array([ 0x7F,  0x00, 0x00])#red
	new Int8Array([ 0x00,  0x7F, 0x00])#green
]

Int8Array_Buffer = (makeBufferFromTypedArray(n) for n in Int8Array_TypedArray)

exports.DrawGLScene_Int8Array_TypedArray = (winObj)-> #Here's Where We Do All The Drawing
	if debugDrawGLScene
	...
	gl.glColor3bv(Int8Array_Buffer[0])
	...
	gl.glColor3bv(Int8Array_Buffer[1])
...
exports.DrawGLScene_Int8Array_Buffer = (winObj)-> #Here's Where We Do All The Drawing
	if debugDrawGLScene
		console.log 'DrawGLScene'
